...
s3_object_key = 'Labevents_prueba.csv'
mysql_table_name = 'datawarehouse.Labevents'
...
def read_csv_from_s3():
    try:
        ...
        # Reemplazar los valores NaN, nulos y vacíos en la columna "hadm_id" con el valor 2222 en una sola línea de código
        df['hadm_id'] = df['hadm_id'].fillna(value=2222).round(decimals=3).replace(' ', '').replace(np.nan, 2222)
